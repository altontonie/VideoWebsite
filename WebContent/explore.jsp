	...
	<div id="page">
		...
		<div id="main">
			...
			<div id="nfl">
				<ul>
					<%
				String user_keyword = "recommended"; 
				try{
			...
			<div id="nfl">
				...
				try{
					...
					Statement statement=connection.createStatement();
					System.out.print("connect successfully!");
					String sql="SELECT * FROM videos where category like '%"+user_keyword3+"%' ";
					ResultSet rs=statement.executeQuery(sql);
					ResultSetMetaData rmeta=rs.getMetaData();
					int numColumns=rmeta.getColumnCount();
			...
			<div id="nfl">
				...
				try{
					...
					Statement statement=connection.createStatement();
					System.out.print("connect successfully!");
					String sql="SELECT * FROM videos where category like '%"+user_keyword4+"%' ";
					ResultSet rs=statement.executeQuery(sql);
					ResultSetMetaData rmeta=rs.getMetaData();
					int numColumns=rmeta.getColumnCount();
