...
<body>
	...
	<div id="page">
		...
		<div id="main">
			<% 
			String user_keyword = request.getParameter("id");
			try{
				/* String user_keyword = ;  */
				...
				String sql="SELECT * FROM videos where id like '%"+user_keyword+"%'";
				...
				{%>
					<div id="test">
						<ul>
							<li><video width="70%" height="60%" controls autoplay muted>
			  				<source src="<%=rs.getString("videoPath") %>" type="video/mp4">
			  				</video>
							<p><strong><%= rs.getString("videoName") %></strong><a href="<%=rs.getString("videoPath") %>" download><br/>Download</a><br/></p>
							<p><%= rs.getString("author") %><br/></p>
							<p><br/><%= rs.getString("description") %></p></li>
						</ul>
					</div>
				<% }
