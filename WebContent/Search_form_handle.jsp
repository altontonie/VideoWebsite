...
<head>
<title>index</title>
<!-- <link rel="shortcut icon" href="upload/images/1_1st_icon.ico"/> -->
...
<body>
	...
	<div id="page">
		...
		<%
		String user_keyword = request.getParameter("search") ; 
		if(user_keyword != null && !user_keyword.isEmpty()){ %>
			<h2>Showing results for "<%=user_keyword %>"<br/></h2>
			<%
		try{
			...
			String sql="SELECT * FROM videos where videoName like '%"+user_keyword+"%' OR author like '%"+user_keyword+"%'";
			...
			{%>
				<div id="test">
					<ul>
						...
						<img src="<%=rs.getString("thumbnailPath") %>"alt="thumbnail" height="140" width="250" align="left">
						<strong><%= rs.getString("videoName") %></strong><br/>
						<br/><%= rs.getString("author") %></a></li>
					</ul>
				</div>
			<%}	
			rs.close();
